...
#define MG_ERR_GENERIC -1 // Use this when building features and intermediate states... (e.g: feature not implemented)
#define MG_SUCCESS 0
...
#define MG_ERR_DIR_OPEN_FAILED 6
#define MG_ERR_DIR_CREATION_FAILED 7
